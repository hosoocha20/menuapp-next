        ...
        <div className="flex flex-col    gap-[1.5rem] md:gap-[3rem]  h-full w-full xl:w-[1000px]  lg:justify-center">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-[1rem] text-gun-powder-950 w-full ">
            <motion.div
              ...
              className="md:flex-1 flex flex-col justify-between md:justify-normal h-[12rem]  sm:h-[14rem] md:h-[24rem]   bg-my-accent-100 px-7 py-4 md:py-5 border border-my-accent-100 rounded-2xl my-bg-shadow"
            >
              <motion.img
                variants={fadeInUpAni}
                src={"/time.svg"}
            ...
            <motion.div
              ...
              whileInView="visible"
              viewport={{ amount: 0.3, once: true }}
              className="md:flex-1 flex flex-col justify-between md:justify-normal  h-[12rem]  sm:h-[14rem] md:h-[24rem]  bg-my-secondary-200 px-7 py-4 md:py-5 border border-my-secondary-200 rounded-2xl my-bg-shadow"
            >
              <motion.img
                variants={fadeInUpAni}
                src={"/efficiency.svg"}
            ...
            <motion.div
              ...
              whileInView="visible"
              viewport={{ amount: 0.3, once: true }}
              className="md:flex-1 flex flex-col justify-between md:justify-normal  h-[12rem]  sm:h-[14rem] md:h-[24rem]   bg-my-purple-200 px-7 py-4 md:py-5 border border-my-purple-200 rounded-2xl my-bg-shadow"
            >
              <motion.img
                variants={fadeInUpAni}
                src={"/easy.svg"}
